...
namespace BotTelegram.Telegram { 
    public partial class StaticChampionData
    {
        [JsonProperty("type")]
    ...
    public enum Version { The991 };

    public partial class StaticChampionData
    {
        public static StaticChampionData FromJson(string json) => JsonConvert.DeserializeObject<StaticChampionData>(json, BotTelegram.Telegram.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this StaticChampionData self) => JsonConvert.SerializeObject(self, BotTelegram.Telegram.Converter.Settings);
    }
    ...
    internal class VersionConverter : JsonConverter
    {
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            if (value == Version.The991)
            {
                serializer.Serialize(writer, "9.9.1");
                return;
            }
